...
var format_highway2_4 = new ol.format.GeoJSON();
var features_highway2_4 = format_highway2_4.readFeatures(json_highway2_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_highway2_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_highway2_4.addFeatures(features_highway2_4);
cluster_highway2_4 = new ol.source.Cluster({
  distance: 30,
  source: jsonSource_highway2_4
});
var lyr_highway2_4 = new ol.layer.Vector({
                declutter: false,
                source:cluster_highway2_4, 
                style: style_highway2_4,
                popuplayertitle: 'highway 2',
                interactive: true,
                title: '<img src="styles/legend/highway2_4.png" /> highway 2'
            });
